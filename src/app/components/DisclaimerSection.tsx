  ...
  return (
    <section className="mt-10 border-t border-sage-100 bg-sage-50/70 py-6 sm:py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-y border-sage-200 bg-card">
            ...
            <Alert className="rounded-none border-0 border-b border-sage-100 bg-transparent p-5 sm:p-6 lg:border-b-0 lg:border-r">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-wrap items-center gap-2">
                  <AlertTitle className="text-lg font-semibold text-forest-900">就診前請確認</AlertTitle>
                  <Badge className="rounded-md bg-honey-100 text-clay-700">重要提醒</Badge>
                </div>
              ...
              {noticeItems.map((item) => {
                ...
                return (
                  <article key={item.title} className="flex gap-3 p-5 sm:p-6 md:flex-col">
                    <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-sage-100 text-forest-800">
                      <Icon />
                    </div>
                    <div>
                      <h3 className="text-sm font-semibold leading-6 text-forest-900">{item.title}</h3>
