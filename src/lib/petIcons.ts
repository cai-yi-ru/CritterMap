...
export const petIconDefinitions: PetIconDefinition[] = [
  ...
  },
  {
    key: "guinea-pig",
    label: "天竺鼠",
    src: "/pet-icons-v3/guinea-pig.webp",
    aliases: ["天竺鼠"],
    filterable: true,
    isExotic: true,
  },
  ...
  },
  {
    key: "amphibian",
    label: "兩棲",
    src: "/pet-icons-v3/amphibian.webp",
  ...
  },
  {
    key: "hedgehog",
    label: "刺蝟",
    src: "/pet-icons-v3/hedgehog.webp",
    aliases: ["刺蝟"],
    filterable: true,
    isExotic: true,
  },
  {
    key: "sugar-glider",
    label: "蜜袋鼯",
    src: "/pet-icons-v3/sugar-glider.webp",
    aliases: ["蜜袋鼯", "飛鼠"],
    filterable: true,
    isExotic: true,
  },
  ...
  },
  {
    key: "chinchilla",
    label: "龍貓",
    src: "/pet-icons-v3/chinchilla.webp",
    aliases: ["龍貓"],
    filterable: true,
    isExotic: true,
  },
  {
    key: "wild-animal",
    label: "野生動物",
    src: "/pet-icons-v3/wild-animal.webp",
    aliases: [
      "野生動物",
      "浣熊",
      "狐獴",
  ...
  },
  {
    key: "other-exotic",
    label: "其他特寵",
    src: "/pet-icons-v3/other-exotic.webp",
    aliases: [
      "其他特寵",
      "其他",
      "其他動物",
...
export function getPetIconDefinition(petName: string) {
  return petIconDefinitions.find((definition) => definition.label === petName || definition.aliases.includes(petName))
